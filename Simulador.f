C     *****************************************************************************
C     * Simulador 1 - Simulaá∆o da fila de um caixa de um mercadinho com um caixa *
C     *****************************************************************************
...
C      Toci: tempo ocioso do caixa, Ç o tempo em que o caixa se encontra sem cliente
...
C      Taux: tempo auxiliar Ç o vetor que guarda os tempos finais anteriores
...
C      Caso 1) Se tempo de fim for menor que tempo real, tempo de in°cio Ç o tempo real
       if(Tf.le.T) Ti=T
C      Caso 2) Se tempo de fim for maior que tempo real, tempo de ini°cio Ç o tempo de fim
       if(Tf.gt.T) Ti=Tf
...
C      Caso 3) Primeira ocorrància, quando chega o primeiro cliente
       if(Tf.eq.0) nsis=1
